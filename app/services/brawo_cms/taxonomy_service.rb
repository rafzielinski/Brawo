module BrawoCms
  class TaxonomyService
    BASE_KEYS = %i[name slug description].freeze
    ...
    class << self
      ...
      def build_attributes(type_config:, params:, wrap_key: :taxonomy)
      ...
      def type_config(type)
        BrawoCms.taxonomy_types[type.to_sym]
      end
      ...
      def type_not_found(type)
        ServiceResult.failure(
          errors: { taxonomy_type: ["'#{type}' not found"] },
